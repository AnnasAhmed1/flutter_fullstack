    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.003, -0.188),
            child: SizedBox(
              width: 117.0,
              height: 17.0,
              child: PageLink(
                links: [
                  PageLinkInfo(
                    duration: NaN,
                    pageBuilder: () => NumberVerification(),
                  ),
                ],
                child: Text(
                  'Send Another Code',
